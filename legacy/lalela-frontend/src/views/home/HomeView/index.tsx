  ...
  'elements': [
    ...
    },
    {
      ...
      'elements': [
        {
          'type': 'Group',
          'label': 'Thank you for taking the time to to report what you have witnessed. This section will focus on the \'where\' and \'when\' of the incident. The sentance continues here but not in caps lock',
          'elements': [
            {
              'type': 'VerticalLayout',
              'elements': [
                ...
                {
                  'type': 'Label',
                  'text': 'Where did this incident take place? Any and all information could be imprtant, please give as much detail as possible',
                },
                {
                  'type': 'Control',
